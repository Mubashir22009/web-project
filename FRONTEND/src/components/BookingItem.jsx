const BookingItem = ({ booking, property }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row bg-gray-700 shadow-md rounded-lg p-4 mb-4 hover:shadow-lg transition-shadow gap-4 border border-blue-500">
      <img
      ...
      <div className="flex flex-col justify-between w-full">
        <div>
          <h3 className="text-blue-400 text-xl font-semibold">{property.title}</h3>
          <p className="text-gray-400">{property.location}</p>
        </div>
        <div className="flex flex-col space-y-2 mt-4">
          <h2 className="text-lg font-semibold text-gray-400">Property ID: {booking.property_id}</h2>
          <h2 className="text-lg font-semibold text-gray-400">Customer ID: {booking.user_id}</h2>
