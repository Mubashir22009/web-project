    ...
    return (
        <div className="min-h-screen flex flex-col bg-gray-800">
            ...
            <div className="flex flex-col items-center mt-8">
                <h1 className="text-center text-white text-2xl sm:text-5xl mt-8">
                    User Profile
                </h1>
                <div className="text-center text-white text-xl sm:text-3xl mt-4">
            ...
            <div className="flex-grow">
                ...
                {!error && !loading && bookings.length === 0 && <div className="text-center text-white text-2xl sm:text-5xl mt-8">
